...
extern "C" {
    ...
    irods::api_entry* plugin_factory(
        ...
        strncpy( api->in_pack_key, "NcInqInp_PI", MAX_NAME_LEN );
        api->inPackInstruct = NcInqInp_PI;
        
        strncpy( api->in_pack_key, "NcInqOut_PI", MAX_NAME_LEN );
        api->inPackInstruct = NcInqOut_PI;
