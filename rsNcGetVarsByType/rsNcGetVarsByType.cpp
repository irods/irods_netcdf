...
extern "C" {
    ...
    irods::api_entry* plugin_factory(
        ...
        strncpy( api->in_pack_key, "NcGetVarInp_PI", MAX_NAME_LEN );
        api->inPackInstruct = NcGetVarInp_PI;
        
        strncpy( api->in_pack_key, "NcGetVarOut_PI", MAX_NAME_LEN );
        api->inPackInstruct = NcGetVarOut_PI;
