...
extern "C" {
    ...
    irods::api_entry* plugin_factory(
        ...
        strncpy( api->in_pack_key, "NcInqGrpsInp_PI", MAX_NAME_LEN );
        api->inPackInstruct = NcInqGrpsInp_PI;
        
        strncpy( api->in_pack_key, "NcInqGrpsOut_PI", MAX_NAME_LEN );
        api->inPackInstruct = NcInqGrpsOut_PI;
